            ...
            <div className="flex rounded-lg bg-gray-800 bg-opacity-60 p-8 flex-col">
                ...
                <div className="flex flex-grow mt-5">
                    <div className="md:w-1/2 sm:w-1/2 flex flex-col items-start">
                        <p className="leading-relaxed text-lg w-full">Start Time</p>
                        <h2 className="text-white text-lg title-font font-medium mt-5">{new Date(props.detail.start_time).toLocaleTimeString()}</h2>
                    </div>
                    <div className="md:w-1/2 sm:w-1/2 flex flex-col items-start">
                        <p className="leading-relaxed text-lg w-full">End Time</p>
                        <h2 className="text-white text-lg title-font font-medium mt-5">{new Date(props.detail.end_time).toLocaleTimeString()}</h2>
                    </div>
                </div>
            </div>
        </div>
